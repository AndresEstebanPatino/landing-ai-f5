...
export default function Home() {
  return (
    ...
    <section class="min-h-screen bg-gradient-to-t from-salmon-f5 to-white">
    <div class="container mx-auto flex min-h-screen flex-col px-6 py-12">
        ...
        <div class="mt-8 lg:mx-6 lg:w-1/2">
            <div class="mx-auto w-full overflow-hidden rounded-3xl bg-white px-8 py-10 shadow-2xl lg:max-w-xl">
