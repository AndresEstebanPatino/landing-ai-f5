        ...
        <div className="container mx-auto flex flex-col items-center px-6 py-10 text-lg">
          ...
          <div className="text-gray-900 mx-auto w-full overflow-hidden rounded-3xl bg-white p-20 shadow-2xl lg:max-w-5xl  font-popins">
            <p className="mb-5 ">
              ...
              <strong>Formato:</strong> 2 sesiones de 3 horas + 30min
              dudas/preguntas<br></br>
              <strong>Modalidad:</strong> Online ¡en directo! Por
              videoconferencia Zoom <br></br>
            </p>
            <strong>Fechas y horarios:</strong>
            <ul className="list-disc mb-5">
              <li>Lunes 10 y Miercoles 12 de julio de 10:00h a 13:30h</li>

              <li>Lunes 10 y Miercoles 12 de julio de 16:00h a 19:30h</li>
            </ul>

            <h4 className="mb-3 text-xl font-bold">Módulo Ciberseguridad:</h4>
            <ul className="list-disc">
              <li>
              Fundamentos de la ciberseguridad y su importancia vital en el entorno empresarial actual.
              </li>
              <li>
              Tipos de ciberataques y cómo evitar que amenacen el funcionamiento de tu empresa.
              </li>
              <li>Cómo incluir la ciberseguridad en tu estrategia corporativa. Áreas críticas en la empresa</li>
            </ul>
            <h4 className="mt-10 mb-3 text-xl font-bold">
              Módulo Inteligencia Artificial:
            </h4>
            <ul className="list-disc">
              <li>Fundamentos de IA, clarificación de conceptos y relevancia en la actual revolución tecnológica.</li>
              <li>Usos de la IA. Aprovecha el potencial de la Inteligencia Artificial para llevar tu empresa al siguiente nivel. Exploración de diversas aplicaciones y casos de uso de la IA. </li>
              <li>Cómo integrar la IA en tus procesos empresariales y tomar decisiones más informadas.</li>
              <li>Descubre las tecnologías y herramientas esenciales de Inteligencia Artificial y cómo aplicarlas. Análisis de aplicaciones de IA.</li>
            </ul>
          </div>
        </div>
      </section>
