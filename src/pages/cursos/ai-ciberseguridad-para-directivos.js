  ...
  return (
    ...
    <nav  className="container mx-auto p-6 lg:flex lg:items-center lg:justify-between ">
      ...
      { /* <!-- Mobile Menu open: "block", Menu closed: "hidden" -->*/}
        ...
        <a className="mt-4 block rounded-3xl bg-orange-f5 px-6 py-2.5 text-center font-medium capitalize leading-5 text-white hover:bg-orange-600 lg:mt-0 lg:w-auto" href="#">Inscripcion </a>
        </div>
    </nav>
